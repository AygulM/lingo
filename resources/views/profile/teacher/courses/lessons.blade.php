...
<!-- start wpo-lesson-section -->
<section class="wpo-lesson-section">
            <h2 class="hidden">hidden</h2>
            <div class="container">
                <div class="row">
                    <div class="col col-xl-12 col-lg-12 col-12">
                        <div class="wpo-lesson-sidebar">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="item">
                                                @foreach ($course->lessons as $lesson)
                                                <li><span>{{$lesson->theme}}</span><a href="{{route('tests.create', $lesson->id)}}">добавить тест</span> </a></li>
